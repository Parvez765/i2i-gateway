    ...
    return (
        <div className='container mx-auto p-10'>
            <div className='grid grid-cols-1 lg:grid-cols-2 lg:gap-[140px]'>
                ...
                <div>
                    <h1 className='text-[35px] lg:text-[50px] font-bold text-[#002060] leading-[50px] mt-[50px] lg:mt-[0]'>Industries We Serve</h1>
                    <div className='mt-[20px] grid grid-cols-2'>
                        {
                            industries?.map(ind => <div className='flex items-center gap-[10px] mt-[15px]'>
