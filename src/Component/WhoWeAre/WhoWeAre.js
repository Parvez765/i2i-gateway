           ...
           <div className='px-6 lg:px-0'>
                ...
                <div className='mt-[32px] flex flex-col lg:flex-row justify-center items-center gap-[24px]'>
                    <div className='text-center card shadow-lg p-5'>
                        ...
                        <p className='text-[18px] font-normal'>Our mission at i2i GATEWAY is to serve as the forefront consultancy partner for Bangladesh's industrial and commercial sectors, providing unparalleled MEP & FIRE consulting services. We aim to offer comprehensive, high-quality solutions that exceed client expectations while fostering innovation, sustainability, and operational excellence.</p>
                    </div>
                    <div className='text-center card shadow-lg p-5'>
                    <h2 className='font-bold text-[32px] mb-[16px]'>Our Vision</h2>
                        <p className='text-[18px] font-normal'>Driven by innovation and a commitment to excellence, our vision is to become the most trusted and sought-after MEP & FIRE consultancy firm in Bangladesh. We aspire to continuously expand our expertise, leverage advanced technologies, and redefine industry standards to deliver transformative solutions that shape a sustainable and prosperous future for our clients and communities.</p>
                    </div>
                </div>
            </div>
        </div>
